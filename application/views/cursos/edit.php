<section class="content">
    ...
    <div class="box">
        ...
        <?php endif ?>
        <?php echo form_open('cursos/update', "enctype=multipart/form-data"); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?php echo form_error('nombre') == true ? 'has-error' : '' ?>">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del Curso" required="required" value="<?php echo set_value('nombre')?:$curso->nombre; ?>">
                            ...
                            <?php foreach ($docentes as $docente): ?>
                                <?php 
                                    ...
                                    if (set_value('docente_id') && set_value('docent_id') == $docente->id){
                                        ...
                                        if ($docente->id == $curso->docente_id) {
                                            $selected = 'selected';
                                        }
                                    }
                                ?>
